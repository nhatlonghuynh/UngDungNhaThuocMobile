              ...
              Row(
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.medication_liquid, size: 30, color: Colors.blueAccent),
                  ),
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: const TextStyle(color: AppColors.primaryPink, fontWeight: FontWeight.bold, fontSize: 16),
                  ),
                ],
              )
            ],
